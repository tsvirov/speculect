...
![speculect scan/pair/bench walkthrough](examples/wow_demo.gif)
...
see [examples/README.md](examples/README.md) for the plain-text transcript,
...
Real captured output: [examples/README.md](examples/README.md). For the
